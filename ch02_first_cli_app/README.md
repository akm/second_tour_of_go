...
あなたは「GoでCLIアプリを書いたことがある(書けるとは言ってない)」と言えるようになりました！
また「Goでインターフェイスによるポリモーフィズムを使ったことがある（使えるとは言っていない）」
と言えるようになりました！

より自信を持てるように、関数の中でif文やswitch文で複雑な処理フローを書くのではなく、
mapや構造体、インターフェイスを使うことで構造を明らかにすることを心がけましょう。
